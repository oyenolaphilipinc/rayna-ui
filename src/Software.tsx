...
export default function SoftwarePage() {
  return (
    <main className="min-h-screen">
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p className="text-gray-600 text-lg mb-8">
              Empowering your business with tailored, secure, and scalable software applications designed to enhance efficiency and
              customer engagement.
            </p>
      ...
      <section className="bg-gray-50 py-16 md:py-24">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">Our expertise in Software Development</h2>
    ...
    <div className="grid md:grid-cols-2 gap-8 items-center py-8">
      <div>
        <h1 className="text-3xl md:text-4xl font-bold mb-6">Custom Software Solutions</h1>
        <p className="text-gray-600 text-lg">
          We create tailor-made applications designed to address the unique challenges of your business. By aligning technology
          with your goals, our custom solutions enhance operational efficiency, improve workflows, and support your growth.
        </p>
      </div>
      <div className="relative h-[300px] md:h-[400px]">
        <img
...
<section className="px-4 py-8">
  ...
  <div className="grid md:grid-cols-2 gap-8 items-center py-8">
      <div className="order-last">
        <h1 className="text-3xl md:text-4xl font-bold mb-6">Mobile App Development</h1>
        <p className="text-gray-600 text-lg">
          Reach your customers wherever they are with innovative mobile applications for Android and iOS. Our apps are designed
          for seamless user experiences, helping businesses increase customer engagement, drive sales, and foster brand loyalty in
    ...
    <div className="grid md:grid-cols-2 gap-8 items-center py-8">
      <div>
        <h1 className="text-3xl md:text-4xl font-bold mb-6">Web Application Development</h1>
        <p className="text-gray-600 text-lg">
          Empower your business with scalable and secure web applications that grow with you. From e-commerce platforms to
          enterprise-level web solutions, we build intuitive applications designed to elevate your online presence and streamline
          operations.
        </p>
      </div>
      <div className="relative h-[300px] md:h-[400px]">
      ...
      <section className="bg-gray-50 py-16 md:py-24">
        <div className="container mx-auto px-4">
          ...
          <p className="text-gray-600 text-center max-w-3xl mx-auto mb-12">
            At Techbor, we combine technical expertise with a deep understanding of your business needs to create software that
            delivers measurable results. Our team ensures timely delivery, cost-effective solutions, and a customer-focused approach
            to every project.
          </p>
        <img
          src="/brainstorm.svg"
